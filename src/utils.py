...
IMPORTANT_ARG_KEYS = [
    ...
    'shieldfl_plaintext_bits',
    'shieldfl_packing_slack_bits',
    'shieldfl_packing_factor',
    'secure_timing_sample_size',
    'paillier_timing_sample_size',
    'disable_secure_protocol_timing',
    'attack',
    'malicious_ratio',
    'sign_flip_lambda',
...
FILENAME_FIELD_ALIASES = {
    ...
    'secure_share_bits': 'ssb',
    'shieldfl_modulus_bits': 'smb',
    'shieldfl_plaintext_bits': 'spb',
    'shieldfl_packing_slack_bits': 'spsb',
    'shieldfl_packing_factor': 'spf',
    'dirichlet_alpha': 'a',
    'attack': 'atk',
    'malicious_ratio': 'mr',
